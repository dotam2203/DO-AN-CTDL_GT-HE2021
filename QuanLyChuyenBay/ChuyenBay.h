...
main:
	...
	{
	xuat:
		gotoXY(5 + moX, 5); cout << "<ESC> QUAY LAI       ";
		int j = 0;
	...
	back1:
		...
		while (v != NULL)
		{
			if (_strcmpi(v->cb.sohieu, ds_cb[a[p]]->sohieu) == 0 && _strcmpi(v->cb.machuyenbay, ds_cb[a[p]]->machuyenbay) != 0 /*|| _strcmpi(v->cb.machuyenbay, ds_cb[a[p]]->machuyenbay) == -1*/)
			{
				...
				{
					gotoXY(94 + moX, 4); cout << "Da co chuyen bay";
					gotoXY(94 + moX, 5); cout << "cach day 4 gio";
					_getch();
					for (int i = 0; i <= 17; i++)
					{
						gotoXY(94 + i + moX, 4); cout << " ";
						gotoXY(94 + i + moX, 5); cout << " ";
						gotoXY(60 + i + moX, 5); cout << " ";
					}
					goto back1;
				}
			}
...
key://============================================================================================================//
	...
	{
		//box_nho(10, 13, 100, 3);
		gotoXY(0 + 65 - 1 + 60 + 30 + 15 + 3 + 3 + 5 + 20, 24); cout << "DA HUY CHUYEN";
		Sleep(300);
		goto back;
	}
	else { goto back; }
...
{
	int movX = 20;
	gotoXY(0 + 65 - 1 + 60 + 30 + 15 + 3 + 3 + movX, 15); cout << "BAN CO CHAC LA HUY KHONG";
...
back1:
	...
	while (p != NULL)
	{
		if (_strcmpi(p->cb.sohieu, x.sohieu) == 0 && _strcmpi(p->cb.machuyenbay, x.machuyenbay) != 0)
		{
			...
			{
				//gotoXY(60, 18);
				gotoXY(94 + movX, 4); cout << "Da co chuyen bay";
				gotoXY(94 + movX, 4); cout << "cach day 4 gio";
				_getch();
				for (int i = 0; i <= 10; i++)
				{
					gotoXY(94 + i + movX, 4); cout << " ";
